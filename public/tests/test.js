...
describe('GameLogic', () => {
	...
	describe('GameLogic vars & functions ', () => {
		...
		it('Set Balance', () => {
			game.setBalance(3)
			assert( game.getBalance()==3 )
			console.log('Set Balance working')
		})
	...
	describe('Roll', () => {
		...
		it('Roll profit', () => {
			assert((!!game.roll(12, 123123, '1232948575382912').profit), 'Proffit true')
			console.log('Profit: ' + game.roll(12, 123123, '1232948575382912').profit)
		})

		it('Roll balance', () => {
			assert( (!!game.roll(12, 123123, '1232948575382912').balance), 'balance true' )
			console.log('Balance: ' + game.roll(12, 123123, '1232948575382912').balance)
		})

		it('Roll timestamp', () => {
			assert( (!!game.roll(12, 123123, '1232948575382912').timestamp), 'timestamp true' )
			console.log('Timestamp: ' + game.roll(12, 123123, '1232948575382912').timestamp)
		})

		it('Roll random_num', () => {
			game.roll(12, 123123, '1232948575382912').random_num
			console.log('Random num: ' + game.roll(12, 123123, '1232948575382912').random_num)
		})
